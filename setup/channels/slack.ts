  ...
  note(
    wrapForGutter(
      [
        ...
        '',
        '  1. Expose NanoClaw\'s webhook server (port 3000) publicly. Options:',
        '     • Tailscale Funnel (recommended — free, stable URL, persistent):',
        '         install Tailscale, sign in, then `tailscale funnel --bg 3000`',
